// https://github.com/aws/aws-cdk/blob/v2.160.0/packages/aws-cdk-lib/aws-stepfunctions/lib/states/item-batcher.ts
...
export class ItemBatcher {
  ...
  public validateItemBatcher(): string[] {
    ...
    if (this.props.maxItemsPerBatch && this.props.maxItemsPerBatchPath) {
      errors.push(
        "Provide either `maxItemsPerBatch` or `maxItemsPerBatchPath`, but not both",
      );
    }

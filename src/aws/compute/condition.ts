// https://github.com/aws/aws-cdk/blob/v2.160.0/packages/aws-cdk-lib/aws-stepfunctions/lib/condition.ts
...
export abstract class Condition {
  ...
  public static booleanEquals(variable: string, value: boolean): Condition {
    return new VariableComparison(
      variable,
      ComparisonOperator.BooleanEquals,
      value,
    );
  }
   ...
   */
  public static booleanEqualsJsonPath(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
      variable,
      ComparisonOperator.BooleanEqualsPath,
      value,
    );
  }
   ...
   */
  public static stringEqualsJsonPath(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
   ...
   */
  public static stringLessThanJsonPath(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
      variable,
      ComparisonOperator.StringLessThanPath,
      value,
    );
  }
   ...
   */
  public static stringLessThanEquals(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
      variable,
      ComparisonOperator.StringLessThanEquals,
      value,
    );
  }
   ...
   */
  public static stringLessThanEqualsJsonPath(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
      variable,
      ComparisonOperator.StringLessThanEqualsPath,
      value,
    );
  }
   ...
   */
  public static stringGreaterThanJsonPath(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
      variable,
      ComparisonOperator.StringGreaterThanPath,
      value,
    );
  }
   ...
   */
  public static stringGreaterThanEqualsJsonPath(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
      variable,
      ComparisonOperator.StringGreaterThanEqualsPath,
      value,
    );
  }
   ...
   */
  public static stringGreaterThanEquals(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
      variable,
      ComparisonOperator.StringGreaterThanEquals,
      value,
    );
  }
   ...
   */
  public static numberEqualsJsonPath(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
   ...
   */
  public static numberLessThanJsonPath(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
      variable,
      ComparisonOperator.NumericLessThanPath,
      value,
    );
  }
   ...
   */
  public static numberLessThanEquals(
    variable: string,
    value: number,
  ): Condition {
    return new VariableComparison(
   ...
   */
  public static numberLessThanEqualsJsonPath(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
      variable,
      ComparisonOperator.NumericLessThanEqualsPath,
      value,
    );
  }
   ...
   */
  public static numberGreaterThanJsonPath(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
      variable,
      ComparisonOperator.NumericGreaterThanPath,
      value,
    );
  }
   ...
   */
  public static numberGreaterThanEquals(
    variable: string,
    value: number,
  ): Condition {
    return new VariableComparison(
   ...
   */
  public static numberGreaterThanEqualsJsonPath(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
      variable,
      ComparisonOperator.NumericGreaterThanEqualsPath,
      value,
    );
  }
   ...
   */
  public static timestampEqualsJsonPath(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
      variable,
      ComparisonOperator.TimestampEqualsPath,
      value,
    );
  }
   ...
   */
  public static timestampLessThanJsonPath(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
      variable,
      ComparisonOperator.TimestampLessThanPath,
      value,
    );
  }
   ...
   */
  public static timestampLessThanEquals(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
      variable,
      ComparisonOperator.TimestampLessThanEquals,
      value,
    );
  }
   ...
   */
  public static timestampLessThanEqualsJsonPath(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
      variable,
      ComparisonOperator.TimestampLessThanEqualsPath,
      value,
    );
  }
   ...
   */
  public static timestampGreaterThan(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
      variable,
      ComparisonOperator.TimestampGreaterThan,
      value,
    );
  }
   ...
   */
  public static timestampGreaterThanJsonPath(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
      variable,
      ComparisonOperator.TimestampGreaterThanPath,
      value,
    );
  }
   ...
   */
  public static timestampGreaterThanEquals(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
      variable,
      ComparisonOperator.TimestampGreaterThanEquals,
      value,
    );
  }
   ...
   */
  public static timestampGreaterThanEqualsJsonPath(
    variable: string,
    value: string,
  ): Condition {
    return new VariableComparison(
...
class CompoundCondition extends Condition {
  ...
  constructor(
    ...
    if (conditions.length === 0) {
      throw new Error(
        "Must supply at least one inner condition for a logical combination",
      );
    }
  }
  ...
  public renderCondition(): any {
    return {
      [CompoundOperator[this.operator]]: this.conditions.map((c) =>
        c.renderCondition(),
      ),
    };
  }

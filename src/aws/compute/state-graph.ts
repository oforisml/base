// https://github.com/aws/aws-cdk/blob/v2.160.0/packages/aws-cdk-lib/aws-stepfunctions/lib/state-graph.ts
...
export class StateGraph {
  ...
  public registerSuperGraph(graph: StateGraph) {
    ...
    if (this.superGraph) {
      throw new Error(
        "Every StateGraph can only be registered into one other StateGraph",
      );
    }

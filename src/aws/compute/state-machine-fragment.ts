// https://github.com/aws/aws-cdk/blob/v2.160.0/packages/aws-cdk-lib/aws-stepfunctions/lib/state-machine-fragment.ts
 ...
 */
export abstract class StateMachineFragment
  extends Construct

 ...
 */
export class HttpInvoke extends compute.TaskStateBase {
  ...
  protected _renderTask(): any {
    return {
      Resource: integrationResourceArn(this, "http", "invoke"),
      Parameters: compute.FieldUtils.renderObject(this.buildTaskParameters()),
    };
  }
